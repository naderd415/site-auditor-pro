...
export const translations: Record<Language, Translation> = {
  ar: {
    ...
    tools: {
      imageConverter: {
        name: 'محول الصور',
        description: 'حول صورك بين الصيغ المختلفة (PNG، JPG، WebP، GIF)',
      ...
      imageCompressor: {
        name: 'ضاغط الصور',
        description: 'قلل حجم صورك مع الحفاظ على الجودة',
      ...
      imageResizer: {
        ...
        description: 'غير أبعاد صورك بسهولة',
      ...
      imageToBase64: {
        ...
        description: 'حول صورك إلى كود Base64',
      ...
      pdfToImage: {
        name: 'PDF إلى صورة',
        description: 'حول صفحات PDF إلى صور',
