...
const passwordSchema = { minLength: 6 };
...
const Admin = () => {
  ...
  // Login page (password only - no email)
  if (!isLoggedIn) {
    return (
      <>
        <Helmet>
    ...
    <>
      ...
      <div className="min-h-screen bg-background text-foreground flex w-full">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground truncate">
                      {isRTL ? 'مدير الموقع' : 'Site Administrator'}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <main className="flex-1 min-w-0 p-4 lg:p-6 overflow-auto">
          ...
          {/* Ads Tab - Using AdsManager Component */}
          {activeTab === 'ads' && (
            <AdsManager 
              config={config} 
              setConfig={setConfig} 
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <div className="space-y-4 max-w-md">
                  <div>
                    ...
                    <Input
                      className="mt-2"
                      value={isRTL ? 'مدير الموقع' : 'Site Administrator'}
                      disabled
                    />
                  </div>
                  <div>
